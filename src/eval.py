...
import utils
import sys
sys.path.insert(0, '/home/xuyuebin/Documents/01/AdaMerging/src')
...
def eval_single_dataset_preprocess_head(image_encoder, head, dataset_name, args):
    ...
    dataset = get_dataset(dataset_name, model.val_preprocess, location=args.data_path,  batch_size=args.batch_size)
    dataloader = get_dataloader(dataset, is_train=False, args=args, image_encoder=None)
    device = args.device
