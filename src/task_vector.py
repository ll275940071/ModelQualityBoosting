...
class TaskVector():
    def __init__(self, pretrained_checkpoint=None, finetuned_checkpoint=None, vector=None, finetuned_dict=None):
        ...
        if vector is not None:
            ...
            with torch.no_grad():
                ...
                if finetuned_dict is not None:
                    finetuned_dict.append(finetuned_state_dict)
